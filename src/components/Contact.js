...
function Contact() {
  ...
  return (
    <section>
      <h1 data-testid="h1tag" className="h1tag">Contact me</h1>
      <hr></hr>
      <div className="email">      <h3>Email address:</h3>
      <a href="mailto:jarmaris.chaney@yahoo.com">@jarmaris.chaney@yahoo.com</a>
      </div>{/* <br></br>
